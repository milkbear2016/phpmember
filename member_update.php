...
if(isset($_POST["action"])&&($_POST["action"]=="update")){	
	...
	//檢查是否有修改密碼
	$mpass = $_POST["m_passwdo"];//舊密碼
	if(($_POST["m_passwd"]!="")&&($_POST["m_passwd"]==$_POST["m_passwdrecheck"])){
		$mpass = password_hash($_POST["m_passwd"], PASSWORD_DEFAULT);//新密碼
	}
	$stmt->bind_param("ssssssssi",$mpass,$m_name,$m_sex,$m_birthday,$m_email,$m_url,$m_phone,$m_address,$m_id);
